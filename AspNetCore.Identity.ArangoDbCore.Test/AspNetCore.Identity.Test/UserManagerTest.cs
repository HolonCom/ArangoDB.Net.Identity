...
namespace AspNetCore.Identity.ArangoDbCore.Test.AspNetCore.Identity.Test
{
    public class UserManagerTest
    {
        ...
        public async Task AuthTokenMethodsFailWhenStoreNotImplemented()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(async () => await manager.GetAuthenticationTokenAsync(null, null, null));
            await Assert.ThrowsAsync<NotSupportedException>(async () => await manager.SetAuthenticationTokenAsync(null, null, null, null));
            await Assert.ThrowsAsync<NotSupportedException>(async () => await manager.RemoveAuthenticationTokenAsync(null, null, null));
        ...
        public async Task AuthenticatorMethodsFailWhenStoreNotImplemented()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(async () => await manager.GetAuthenticatorKeyAsync(null));
            await Assert.ThrowsAsync<NotSupportedException>(async () => await manager.ResetAuthenticatorKeyAsync(null));
        }
        ...
        public async Task RecoveryMethodsFailWhenStoreNotImplemented()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(async () => await manager.RedeemTwoFactorRecoveryCodeAsync(null, null));
            await Assert.ThrowsAsync<NotSupportedException>(async () => await manager.GenerateNewTwoFactorRecoveryCodesAsync(null, 10));
        }
